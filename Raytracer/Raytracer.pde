...
int bounces = 20;
PVector density = new PVector(8, 8);
int f = 0;
int g = 0;
...
void setup() {
  ...
  //light source
  objects[2] = new Sphere(new PVector(300, -120, 1200), 120, new PVector(255, 255, 255), 1, 1, 1);
  
  
  //small sphere
  objects[0] = new Sphere(new PVector(300, 300, 900), 150, new PVector(0, 0, 255), 0.2, 0.2, 0);
  
  //big sphere (subsoil)
  objects[1] = new Sphere(new PVector(300, 1650, 1200), 1200, new PVector(100,100,100), 0.2, 0.3, 0);
  
  objects[3] = new Sphere(new PVector(30000, 1000, 1200), 4000, new PVector(255,255,255), 1,1, 1);
